...
for i = 3:4:length(files)
    ...
    for zz = min_z:max_z
        ...
        img_file_name = strcat(strtok(filename, '_label.hdr'), '_img_train_', string(zz), '.png');
        mask_file_name = strcat(strtok(filename, '_label.hdr'), '_mask_train_', string(zz), '.png');
        edge_file_name = strcat(strtok(filename, '_label.hdr'), '_edge_train_', string(zz), '.png');
